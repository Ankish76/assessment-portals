...
import {
	...
	SharedSlice,
	SharedStoreValues,
} from "@root/modules/sharedStore/store";
import {
	createProjectAssessmentSlice,
	ProjectAssessmentStoreValues,
	ProjectAssessmentSlice,
} from "@root/modules/assessment/store";
import {
	RiskSlice,
	RiskStoreValues,
	createRiskSlice,
	...
	return create(
		persist<StoreInterface>(
			(...a) => ({
				...
				// ),
				...createdProjectFeedbackSlice(
					removeUndefined({ projectFeedbacks, dashboardProjects }),
				)(...a),
				...createDashboardSlice(
					removeUndefined({
						dashboardProjectsRatings,
				...
				...createSharedSlice(removeUndefined({ projectStatus }))(...a),
				...createProjectAssessmentSlice(
					removeUndefined({ projectAssessmentsData }),
				)(...a),
				...createRiskSlice(
					removeUndefined({
						riskData,
