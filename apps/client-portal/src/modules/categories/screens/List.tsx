...
import AddCategory from "@modules/categories/form/AddCategory";
import { TableHeaders } from "@root/modules/categories/constants";
...
const CategoryList: React.FC = () => {
	...
	return (
		<SingleSection
			...
			count={categories?.length != 0 ? categories?.length : undefined}
			button={
				<ButtonWithIcon
